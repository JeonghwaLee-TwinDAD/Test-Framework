...
<Library LVVersion="25008000">
	...
	<Item Name="Abstract Engine.lvclass" Type="LVClass" URL="../Abstract Engine/Abstract Engine.lvclass"/>
	<Item Name="Abstract Instrument.lvclass" Type="LVClass" URL="../Abstract Instrument/Abstract Instrument.lvclass"/>
	<Item Name="Abstract Channel.lvclass" Type="LVClass" URL="../Abstract Channel/Abstract Channel.lvclass"/>
	<Item Name="Engine configuration.lvclass" Type="LVClass" URL="../Engine configuration/Engine configuration.lvclass"/>
	<Item Name="Instrument configuration.lvclass" Type="LVClass" URL="../Instrument configuration/Instrument configuration.lvclass"/>
	<Item Name="Channel configuration.lvclass" Type="LVClass" URL="../Channel configuration/Channel configuration.lvclass"/>
</Library>
