...
<Library LVVersion="25008000">
	...
	<Item Name="Device" Type="Folder">
		<Item Name="NI-Sync.lvclass" Type="LVClass" URL="../NI-Sync/NI-Sync.lvclass"/>
	</Item>
	<Item Name="Synchronization Engine.lvclass" Type="LVClass" URL="../Synchronization Engine/Synchronization Engine.lvclass"/>
	<Item Name="Synchronization Instrument.lvclass" Type="LVClass" URL="../Synchronization Instrument/Synchronization Instrument.lvclass"/>
	<Item Name="Synchronization configuration.lvclass" Type="LVClass" URL="../Synchronization configuration/Synchronization configuration.lvclass"/>
	<Item Name="Synchronization Channel.lvclass" Type="LVClass" URL="../Synchronization Channel/Synchronization Channel.lvclass"/>
	<Item Name="Synchronization Channel configuration.lvclass" Type="LVClass" URL="../Synchronization Channel configuration/Synchronization Channel configuration.lvclass"/>
</Library>
