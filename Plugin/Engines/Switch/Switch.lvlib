...
<Library LVVersion="25008000">
	...
	<Item Name="Device" Type="Folder">
		<Item Name="NI Switch.lvclass" Type="LVClass" URL="../NI Switch/NI Switch.lvclass"/>
		<Item Name="Hioki 9002.lvclass" Type="LVClass" URL="../Hioki 9002/Hioki 9002.lvclass"/>
	</Item>
	<Item Name="Switch Engine.lvclass" Type="LVClass" URL="../Switch Engine/Switch Engine.lvclass"/>
	<Item Name="Switch Instrument.lvclass" Type="LVClass" URL="../Switch Instrument/Switch Instrument.lvclass"/>
	<Item Name="Switch configuration.lvclass" Type="LVClass" URL="../Switch configuration/Switch configuration.lvclass"/>
	<Item Name="Switch Channel.lvclass" Type="LVClass" URL="../Switch Channel/Switch Channel.lvclass"/>
	<Item Name="Switch Channel configuration.lvclass" Type="LVClass" URL="../Switch Channel configuration/Switch Channel configuration.lvclass"/>
</Library>
