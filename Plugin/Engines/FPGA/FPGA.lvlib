...
<Library LVVersion="25008000">
	...
	<Item Name="Device" Type="Folder">
		<Item Name="R-Series.lvclass" Type="LVClass" URL="../R-Series/R-Series.lvclass"/>
		<Item Name="CompactRIO.lvclass" Type="LVClass" URL="../CompactRIO/CompactRIO.lvclass"/>
	</Item>
	<Item Name="FPGA Engine.lvclass" Type="LVClass" URL="../FPGA Engine/FPGA Engine.lvclass"/>
	<Item Name="FPGA Instrument.lvclass" Type="LVClass" URL="../FPGA Instrument/FPGA Instrument.lvclass"/>
	<Item Name="FPGA configuration.lvclass" Type="LVClass" URL="../FPGA configuration/FPGA configuration.lvclass"/>
	<Item Name="FPGA Channel.lvclass" Type="LVClass" URL="../FPGA Channel/FPGA Channel.lvclass"/>
	<Item Name="FPGA Channel configuration.lvclass" Type="LVClass" URL="../FPGA Channel configuration/FPGA Channel configuration.lvclass"/>
</Library>
