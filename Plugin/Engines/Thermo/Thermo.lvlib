...
<Library LVVersion="25008000">
	...
	<Item Name="Device" Type="Folder">
		<Item Name="NI Thermo.lvclass" Type="LVClass" URL="../NI Thermo/NI Thermo.lvclass"/>
	</Item>
	<Item Name="Thermo Engine.lvclass" Type="LVClass" URL="../Thermo Engine/Thermo Engine.lvclass"/>
	<Item Name="Thermo Instrument.lvclass" Type="LVClass" URL="../Thermo Instrument/Thermo Instrument.lvclass"/>
	<Item Name="Thermo configuration.lvclass" Type="LVClass" URL="../Thermo configuration/Thermo configuration.lvclass"/>
	<Item Name="Thermo Channel.lvclass" Type="LVClass" URL="../Thermo Channel/Thermo Channel.lvclass"/>
	<Item Name="Thermo Channel configuration.lvclass" Type="LVClass" URL="../Thermo Channel configuration/Thermo Channel configuration.lvclass"/>
</Library>
